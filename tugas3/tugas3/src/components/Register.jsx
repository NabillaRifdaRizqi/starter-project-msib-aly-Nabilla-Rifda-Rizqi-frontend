...
const Register = () => {
    return (
           <div className="w-full h-full flex flex-col md:flex-row">
            <div className="w-full md:w-1/2 h-96 md:h-full overflow-hidden">
            <img 
            src={COVER_IMAGE} 
            className="w-full  object-cover h-[121vh]" 
            alt="Cover" 
        />
            </div>
            <div className="w-full md:w-1/2 h-2/3 md:h-full bg-[#FFF9F1] flex flex-col justify-center items-center p-10">
                <div className="w-2/3">
                    <img 
                        src={LOGO_IMAGE} 
                    ...
                    <form autoComplete="off">
                        ...
                        <input 
                            ...
                            className='w-full text-black py-4 my-4 bg-[#FFF9F1] border border-[#C1D1FF] rounded-md p-2.5 '
                            autoComplete="off"
                        />
                    ...
                    <div className='w-full flex items-center justify-center relative py-2'>
                        ...
                        <p className='text-lg absolute text-grey bg-[#FFF9F1]'>Or, Register with</p>
                    </div>

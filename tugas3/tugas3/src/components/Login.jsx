...
import COVER_IMAGE from '../assets/cover1.jpg';
...
const Login = () => {
    ...
    <div className="w-full md:w-1/2 h-full md:h-screen overflow-hidden">
        <img 
            src={COVER_IMAGE} 
    ...
    <div className="w-full md:w-1/2 h-full md:h-screen bg-[#FFF9F1] flex flex-col justify-center items-center p-10">
                <div className="w-2/3">
                    <img 
                        src={LOGO_IMAGE} 
                    ...
                    <input 
                        ...
                        className='w-full text-black py-4 my-4 bg-[#FFF9F1] border border-[#C1D1FF] rounded-md p-4  focus:border-indigo-500'
                    ...
                    <input 
                        ...
                        className='w-full text-black py-4 my-4 bg-[#FFF9F1] border border-[#C1D1FF] rounded-md p-4  focus:border-indigo-50 '
                    ...
                    <div className='w-full flex flex-col my-4'>
                        <button className='w-full text-black bg-[#FFF9F1] border border-[#C1D1FF] rounded-md p-4 text-center flex items-center justify-center'>

...
<main className="w-full min-h-screen py-1 md:w-2/3 lg:w-3/4">
    <div className="p-1 md:p-2 bg-[#FFF9F1] flex-1 border-[2px] radius-15px mx-auto sm:max-w-md rounded-md ">
            ...
            <div className="grid max-w-2xl mx-auto mt-8">
                <div className="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0">
                    ...
                    <div className="flex flex-col space-y-5 sm:ml-8">
                        ...
                        <button
                            type="button"
                            className="py-3.5 px-7 text-base font-medium text-indigo-900 focus:outline-none bg-[#FFF9F1] rounded-lg border border-indigo-200 hover:bg-indigo-100 hover:text-[#202142] focus:z-10 focus:ring-4 focus:ring-indigo-200"
                        >
                            Delete picture
                        </button>
                    </div>
                ...
                <div className="items-center mt-8 sm:mt-14 text-[#202142] flex flex-col sm:flex-row">
                    <div className="w-40 mr-4">
                        ...
                        <input
                            type="text"
                            id="first_name"
                            className="bg-[#FFF9F1] border border-[#C1D1FF] text-indigo-900 text-sm rounded-md  focus:ring-indigo-500 focus:border-indigo-500 block w-40 p-2.5"
                    ...
                    <div className="w-40">
                        ...
                        <input type="text" 
                        id="last_name" 
                        className="bg-[#FFF9F1] border border-[#C1D1FF] text-indigo-900 text-sm rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-52 p-2.5" 
                ...
                <div className="mb-2 sm:mb-6 mt-4">
                    ...
                    <input type="text" id="kursus" className="bg-[#FFF9F1] border border-[#C1D1FF] text-indigo-900 text-sm rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:w-96 p-2.5" required />
                </div>
                <div className="mb-2 sm:mb-6">
                    ...
                    <input type="email" id="profession" className="bg-[#FFF9F1] border border-[#C1D1FF] text-indigo-900 text-sm rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:w-96 p-2.5" placeholder="your.email@mail.com" required />
                </div>
                <div className="mb-6">
                    ...
                    <input type="text" id="nohp" className="bg-[#FFF9F1] border border-[#C1D1FF] text-indigo-900 text-sm rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:w-96 p-2.5"  required />
                </div>
...
<div className="flex justify-end">
    <div className="p-1 md:p-2 bg-[#FFF9F1] flex-1 border-[2px] radius-15px mx-auto sm:max-w-md h-96 rounded-md ">
            ...
            <div className="flex flex-col w-full space-y-2">
                <div className="w-full  items-center text-[#202142] text-left">
                    ...
                    <input
                        type="password"
                        id="old_password"
                        className="bg-[#FFF9F1] border border-[#C1D1FF] text-indigo-900 text-sm rounded-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:w-72 p-2.5"
                        required
                    />
                </div>
